...
let WKWebViewManager = NativeModules.RNWKWebViewManager;
...
let WKWebView = React.createClass({
    statics: {
    ...
    render() {
        ...
        if (this.state.viewState === WebViewState.LOADING) {
            ...
            console.error(
                'RNWKWebView invalid state encountered: ' + this.state.loading
            );
        }
    ...
    goForward: function () {
        UIManager.dispatchViewManagerCommand(
            ...
            UIManager.RNWKWebView.Commands.goForward,
            null
        );
    },
    ...
    goBack: function () {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.RNWKWebView.Commands.goBack,
            null
        );
    },
    ...
    reload: function () {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.RNWKWebView.Commands.reload,
            null
        );
    },
    ...
    stopLoading: function () {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.RNWKWebView.Commands.stopLoading,
            null
        );
    },
...
let RNWKWebView = requireNativeComponent('RNWKWebView', WKWebView, {
    nativeOnly: {
        onLoadingStart: true,
        onLoadingError: true,
